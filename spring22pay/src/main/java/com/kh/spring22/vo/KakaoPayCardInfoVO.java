...
public class KakaoPayCardInfoVO {
	...
	private String kakaopay_purchase_corp, kakaopay_purchase_corp_code;//카카오페이 매입사 정보
	private String kakaopay_issuer_corp, kakaopay_issuer_corp_code;//카카오페이 발급사 정보
