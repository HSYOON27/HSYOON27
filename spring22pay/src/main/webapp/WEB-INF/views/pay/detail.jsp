...
<!-- <h2>총금액 :  -->
<%-- <fmt:formatNumber value="${paymentDto.paymenTotal}" pattern="#,##0.00"> --%>
<%-- </fmt:formatNumber>${paymentDto.paymentTotal}원 --%>
<!-- </h2> -->
...
<h2>취소 시각 : <fmt:formatDate value="${response.approved_at}" pattern="y년 M월 d일 E a h시 m분 s초"/></h2>
