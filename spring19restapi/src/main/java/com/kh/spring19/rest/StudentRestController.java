...
// @ParameterObject로 대체하여 사용할 것을 권장	
	...
	@PostMapping("/")
	public void add(@ParameterObject StudentDto dto) {
		repo.insert(dto);
	}
	...
	@GetMapping("/{no}")
	   ...
	   @PutMapping("/")
	   public void edit(@ModelAttribute StudentDto dto) throws NoHandlerFoundException {
