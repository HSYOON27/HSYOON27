...
//		param.put("memberNick", "유저"); //이러면 둘 다 있어야 된다는거 
//		param.put("memberLevelList", List.of("일반회원", "우수회원", "관리자"));
//		param.put("memberEmail", "kh.com");
//		param.put("memberBirth", "1990");
//		param.put("memberTel", "01050531973");
//		param.put("memberAddress", "서울시");
//		param.put("minPoint", 100);
//		param.put("maxPoint", 10000);
//		param.put("beginJoindate", "2023-03-01");
//		param.put("endJoindate", "2023-03-28");
