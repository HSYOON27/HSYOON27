...
public class Test02 {
	public static void main(String[] args) {
		...
		// - 조회결과(ResultSet)를 어떻게 담을 것인지를 알려줘야한다. 정의해야함
		// - 조회 결과를 담기 위한 객체 생성용 클래스가 필요한다. 이걸 DTO 라고 부른다(Data Transfer Object)
		...
		// 변환 방법을 정의하는 객체를 생성한다(RowMapper)
		...
		RowMapper<PocketmonDto> mapper = new RowMapper<PocketmonDto>() {
			...
			public PocketmonDto mapRow(ResultSet rs, int arg1) throws SQLException {
				...
				return dto; // 다시 보내 주는거
			}
		};

		//조회를 위한 별도의 명령을 사용합니다
